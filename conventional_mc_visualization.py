...
epsilon_LJ = 4; sigma_LJ = 3  # they should be different for different particles
random_force_strength =0
const_force = 0  # constant force that drives water molecule towards the right
...
def init_config():
    ...
    temp_x = np.random.uniform(low=0.0 * L_channel, high=1* L_channel) #I made it closer to the center
...
if __name__ == '__main__':
    ...
    #visualization fuction to assist debug
    visual(coords_negative_particles,coords_particles,my_positions,my_velocities)
